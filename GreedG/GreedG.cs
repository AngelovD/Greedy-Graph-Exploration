...
namespace Maes.ExplorationAlgorithm.GreedG
{

    
    public partial class GreedGAlgorithm : IExplorationAlgorithm
    {
        ...
        public void UpdateLogic()
        {
            ...
            var receivedNeighbours = new List<NeighbourList>(_controller.ReceiveBroadcast().OfType<NeighbourList>());
